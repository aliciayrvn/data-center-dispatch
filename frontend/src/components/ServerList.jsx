// // Приложение для управления дата-центром
...
//       } catch (e) {
//         setServers([
//           { id: 1, name: 'Server-1', status: true, cpu_load: 23, ram_usage: 45, temperature: 60 },
//           { id: 2, name: 'Server-2', status: false, cpu_load: 0, ram_usage: 0, temperature: 0 },
//           { id: 3, name: 'Server-3', status: true, cpu_load: 67, ram_usage: 80, temperature: 75 },
//         ]);
//       }
//     };
//     fetchServers();
...
//         <span>
//           <img
//             src="/chest.png" // Положите chest.png в папку public!
//             alt="chest"
      ...
      >
        {selectedServer && (
          <div>
            ...
            <p><b>Температура:</b> {selectedServer.temperature}°C</p>
